        ...
        for i in range(num_epochs):
            ...
            for dl in train_dl:
                for texts, labels, lengths in dl:
                    ...
                    embed_text.requires_grad = True
                    logits = pending_model(embed_text, lengths)
                    ...
                    print("Grad:")
                    print("grad size: " + str(embed_text.grad.size()))
                    print(embed_text.grad)
                    print("grad data:")
                    print(embed_text.grad.data)
                    print("Loss:")
                    print(loss)
                    optimizer.step()
                    break
